                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group mb-4">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control form control-sm" value="2025-12-04">
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-hover table-bordered table-sm table-info border-light">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="" align="left">8000000 </td>
